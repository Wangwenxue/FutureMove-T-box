...
#define CPU_XTAL_CLK_HZ                 0x7A1200UL   // wenxue for FutureMove
...
#define CPU_CORE_CLK_HZ_CONFIG_0        0x05B8D800UL    /* Core clock frequency in clock configuration 0 */ // 96M
#define CPU_BUS_CLK_HZ_CONFIG_0         0x02DC6C00UL    /* Bus clock frequency in clock configuration 0 */  // 48M
#define CPU_FLEXBUS_CLK_HZ_CONFIG_0     0x02DC6C00UL    /* Flexbus clock frequency in clock configuration 0 */ // 48M
#define CPU_FLASH_CLK_HZ_CONFIG_0       0x016E3600UL    /* FLASH clock frequency in clock configuration 0 */  // 24M
#define CPU_USB_CLK_HZ_CONFIG_0         0x02DC6C00UL    /* USB clock frequency in clock configuration 0 */
#define CPU_PLL_FLL_CLK_HZ_CONFIG_0     0x05B8D800UL    /* PLL/FLL clock frequency in clock configuration 0 */ // 96M
#define CPU_MCGIR_CLK_HZ_CONFIG_0       0x00UL          /* MCG internal reference clock frequency in clock configuration 0 */
//#define CPU_OSCER_CLK_HZ_CONFIG_0       0x02FAF080UL    /* System OSC external reference clock frequency in clock configuration 0 */// 50M
#define CPU_OSCER_CLK_HZ_CONFIG_0       0x7A1200UL    // wenxue for FutureMove
